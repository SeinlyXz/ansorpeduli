...
<DaruratNav {pathname}/>
<section class="px-[16px] pt-[16px] pb-[90px] flex flex-col gap-y-2">
    {#each datas as data}
                ...
                <section class="flex gap-x-[10px] mt-3 items-center">
                    ...
                    <section class="flex flex-wrap gap-1">
                        {#each data.mitra as mitra}
                            <p class="bg-[#DEF7EC] text-[#03543F] px-[10px] py-[2px] rounded-[6px] text-center font-semibold text-[12px]"> 
                                {mitra}
                            </p>
                        {/each}
                    </section>
